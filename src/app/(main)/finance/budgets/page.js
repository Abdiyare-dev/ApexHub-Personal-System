  ...
  return (
    <div className="module-container fade-in">
      ...
      <div className="budget-kpi-grid">
        ...
        <div className="kpi-card glass-3d">
          <div className="kpi-header">
            ...
            <div className={`kpi-icon-wrap ${budgetData.overBudgetCount > 0 ? 'coral' : 'green'}`}>
          ...
          <div className="health-status-wrap">
            <span className={`health-status-badge ${budgetData.overBudgetCount > 0 ? 'over' : 'ontrack'}`}>
              <span className="health-status-dot" />
              {budgetData.overBudgetCount > 0 ? `${budgetData.overBudgetCount} Over Budget` : 'On Track'}
            </span>
          </div>
      ...
      <style jsx>{`
        ...
        .health-status-badge.ontrack {
          background: rgba(16, 185, 129, 0.12);
          color: #10b981;
          border: 1px solid rgba(16, 185, 129, 0.28);
        }

        .health-status-badge.over {
          background: rgba(239, 68, 68, 0.12);
          color: #ef4444;
